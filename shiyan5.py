...
parser.add_argument("--colors", type=int, default=[[0, 255, 0], [255, 0, 0],[1, 0, 255],[111, 74, 0],[70, 70, 70],[128, 64, 128],[0, 0, 0],[102, 102, 156],[190, 153, 153],[150, 100, 100],[107, 142, 35],
                 [152, 251, 152],[70, 130, 180],[220, 220, 0],[119, 11, 32],[215, 166, 66],[66, 88, 99],[154, 25, 244],[10, 155, 83]], help="masks")
parser.add_argument("--samples", type=str, default="samples//", help="path for test sample")
parser.add_argument("--outputs", type=str, default="outputs//", help="path for save result")
parser.add_argument("--outputs1", type=str, default="outputs1//", help="path for save result")
parser.add_argument("--train_txt", type=str, default="train.txt", help="path for training sample")
